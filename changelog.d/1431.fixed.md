- #1431: after #1389 demoted `setup`, `scaffold`, `triage`, `curate` and
  ...
  instruction. `commands/doctor.md` and `commands/tick.md` -- the two files
  #1389 deliberately kept at the top level -- are swept: each instructive
  ...
  says `/oss:run setup` / `/oss:run scaffold`, or drops the exact
  slash-command spelling entirely in favour of naming the step.
