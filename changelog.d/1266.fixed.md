- The release procedure now waits for the release commit's own CI to conclude before creating and
  ...
  straight to the default branch) polls the commit's own workflow runs and answers green, red or
  pending/timeout; a release only proceeds to tag on green (#1266).
