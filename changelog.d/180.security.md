...
- Fixed at both layers, because they close different halves. A refusal is a claim about the value
  ...
  would accept is still accepted. At render time the code block's fence and the code span's
  delimiter are each widened past the longest backtick run in the value they carry.
