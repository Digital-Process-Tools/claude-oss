...
| Filing | `gh-issue-create:@FILE` — the payload carries `labels.filed_by_loop`'s label only for a filing the loop made on its own initiative, never for one co-decided with the maintainer in session (#762, #798, #1083) |
