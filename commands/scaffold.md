...
already has everything. `trap.d/README.md` is the odd one out among the five: it is the one file the
plugin owns *outside* `.oss/`, because `.oss/` is a directory this plugin owns outright and `trap.d/`
