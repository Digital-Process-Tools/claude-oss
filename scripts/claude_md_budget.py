...
BUDGETS: dict[str, tuple[int, int]] = {
    ...
    # own row and ceiling raised, plus this row and weighed sentence recording it.
    # 54831 B became 56318 B, past the 55200 B ceiling. Ceiling moves to 56700 B,
    # ~1.1% headroom.
    "CLAUDE.md": (56318, 56700),
}
