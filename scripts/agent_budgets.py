...
BUDGETS: dict[str, tuple[int, int]] = {
    ...
    # #1499, re-measured after rebasing over #1532 and #1535: the optional
    # `COST:` self-report and what a tick is expected to say about its own
    # spend. 19911 B became 20797 B. Ceiling unchanged; 203 B headroom, which
    # is tight -- the next edit here pays for itself or raises the ceiling.
    "agents/sub-manager.md": (20797, 21000),
